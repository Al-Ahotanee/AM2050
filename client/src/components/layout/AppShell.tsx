  ...
  const rail = (
    <aside className="flex h-full w-[17.5rem] shrink-0 flex-col bg-[#123148] text-[#f7f4ec] shadow-[12px_0_36px_rgba(18,49,72,0.12)]">
      <div className="flex h-[5.15rem] items-center justify-between border-b border-white/10 px-5">
        <Link href="/workspace" onClick={closeMobile} className="flex items-center gap-3">
          <span className="grid h-10 w-10 place-items-center rounded-[0.8rem] bg-[#f8f6ef] shadow-sm">
            <LogoMark size={30} />
          </span>
          <span>
            <span className="block font-display text-sm font-semibold tracking-[-0.03em] text-white">AM2050</span>
            <span className="block font-mono text-[0.6rem] font-medium tracking-[0.13em] text-[#9cc8ae]">
              AREWA MISSION
            </span>
          </span>
        </Link>
      ...
      <main className="min-h-screen lg:pl-[17.5rem]">
        <header className="sticky top-0 z-30 flex h-[5.15rem] items-center justify-between border-b border-[#d8e0da] bg-[#fbfaf6]/95 px-4 backdrop-blur-md sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            ...
            <Link href="/workspace" className="hidden items-center gap-2.5 border-r border-[#d8e0da] pr-5 xl:flex">
              <span className="grid h-9 w-9 place-items-center rounded-lg border border-[#d8e0da] bg-white">
                <LogoMark size={27} />
              </span>
              <span>
                <span className="block font-display text-sm font-semibold tracking-[0.13em] text-[#123148]">
                  AM2050
                </span>
                <span className="mt-0.5 block font-mono text-[0.54rem] font-medium tracking-[0.13em] text-[#167a4c]">
                  AREWA MISSION · 2050
                </span>
              </span>
            ...
            <div className="sm:hidden">
              <p className="font-display text-sm font-semibold tracking-[0.1em] text-[#123148]">AM2050</p>
              <p className="coordinate-label">Nationwide field platform</p>
            </div>
          </div>
